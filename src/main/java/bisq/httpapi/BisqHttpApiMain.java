...
import bisq.core.app.BisqDaemonModule;
 ...
 */
@Slf4j
public class BisqHttpApiMain extends BisqExecutable implements UncaughtExceptionHandler {
    ...
    public static void main(String[] args) throws Exception {
        if (BisqExecutable.setupInitialOptionParser(args)) {
            ...
            Thread.currentThread().setContextClassLoader(BisqHttpApiMain.class.getClassLoader());

            new BisqHttpApiMain().execute(args);
        }
    }
